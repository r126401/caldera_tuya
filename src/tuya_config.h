 ...
 */
// clang-format off
#define TUYA_PRODUCT_ID      "octb2mgooauu2p3z"                        // Please change your product key
#define TUYA_OPENSDK_UUID      "uuida944bf726fb9a4d0"                    // Please change the correct uuid
#define TUYA_OPENSDK_AUTHKEY   "PLBuA0uReiLq9vzZjxvUJESTh1GrjzlE"        // Please change the correct authkey
